<?php 
    ...
    if($_POST){
        $nama = $_POST['nama'];
            ...
            $inP = mysqli_query($conn,"insert into pelanggan(nama,alamat,username,password) value('$nama','$alamat','$username','$password')");
            if($inP){
          ...
          <div class="card-body p-md-5">
            <div class="row justify-content-center">
              <div class="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
                ...
                <form class="mx-1 mx-md-4" action="pelanggan.php" method="post" >

                  <div class="d-flex flex-row align-items-center mb-4">
                    <i class="fas fa-user fa-lg me-3 fa-fw"></i>
                    <div class="form-outline flex-fill mb-0">
                      <input name="nama" type="text" id="form3Example1c" class="form-control" />
                  ...
                  <div class="d-flex flex-row align-items-center mb-4">
                    ...
                    <div class="form-outline flex-fill mb-0">
                        <input name="alamat" type="text" id="form3Example3c" class="form-control col-6" />
